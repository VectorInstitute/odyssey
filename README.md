...
11. Concept-set widening (built as `task_set="v3"`: 11 added LOINC-keyed concepts, electrolytes/glucose/anemia/coagulation/acidosis/shock), plus leakage metrics (CTL/ICL) reported per run (open)
